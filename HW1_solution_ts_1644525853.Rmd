---
title: "140.653 Homework 1 Solutions"
date: "2/9/2022"
...
```{r,results='hide',fig.height=2.5,fig.width=4}
library(dagR)
...
We choose three children aged 6, 32 and 58, respectively. Their “weights” for the weighted average are given by 20th, 100th and 180th row of H.
...
The non-CV prediction error continues to decrease as the number of degrees of freedom increase; while the CV prediction error achieves a minimum at 2 degrees of freedom.  In addition, the non-CV prediction error is lower than the CV prediction at each degree of freedom, which represents the over-optimism when using the same data to fit and evaluate a model.
